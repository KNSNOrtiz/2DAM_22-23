...
public class JdConectar extends javax.swing.JDialog {
    ...
    private void btConectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConectarActionPerformed
        ...
        try {
            fPrincipal.con = DriverManager.getConnection(cadena, txtUsuario.getText().trim(), txtPassword.getText().trim());
            if (fPrincipal.con != null) {
                JOptionPane.showMessageDialog(null, "Conexión con éxito. Bienvenido/a.","Mensaje", JOptionPane.INFORMATION_MESSAGE);
                dispose();
            }
            else{
                System.exit(0);
            ...
            JOptionPane.showMessageDialog(null, "Error en la conexión a Oracle.", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
            System.exit(0);
        }

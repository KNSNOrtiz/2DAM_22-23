...
public class dialogAlta extends javax.swing.JDialog {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        int edad = 0;
        if (txtMatricula.getText().length() == 0 || txtNombre.getText().length() == 0 || txtFnac.getText().length() == 0 || txtNota.getText().length() == 0 || txtEdad.getText().length() == 0) {
            JOptionPane.showMessageDialog(null, "ERROR: Ningún campo puede estar vacío.");
            return;
        }
        try {
            numMatricula = Integer.valueOf(txtMatricula.getText());
            if (CtrlAlumnos.comprobarMatricula(numMatricula) == -1) {
                JOptionPane.showMessageDialog(null, "ERROR: Este número de matrícula ya ha sido registrado.");
                return;
            }
        ...
        Alumno al = new Alumno(numMatricula,nombre,fecha,notaMedia,edad);
        mainFrame.listaAlumnos.add(al);
        this.dispose();

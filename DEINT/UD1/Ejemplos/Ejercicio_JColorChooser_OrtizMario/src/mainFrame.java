...
public class mainFrame extends javax.swing.JFrame {
    ...
    public static Color colorEtiqueta;
    ...
    private void initComponents() {
        ...
        setTitle("Ejercicio: JColorChooser | Ortiz Jibaja, Mario");
        setResizable(false);

        txtEtiqueta.setText("Esto es un texto de ejemplo");

        btnColores.setText("Seleccionar color...");
    ...
    private void btnColoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColoresActionPerformed
        dialogColores dialog = new dialogColores(this, true);
        int res = dialog.showDialog();
        if (res == JOptionPane.YES_OPTION) {
            txtEtiqueta.setForeground(colorEtiqueta);
        }

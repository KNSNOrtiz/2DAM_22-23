...
public class RelojDigitalBeanInfo extends SimpleBeanInfo {
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_horasCoinciden65] = new MethodDescriptor(relojdigital.RelojDigital.class.getMethod("horasCoinciden", new Class[] {java.util.Date.class, java.util.Date.class})); // NOI18N

...
listaFormas = [forma, rectangulo, elipse, cuadrado, circulo]


for forma in listaFormas:
    print("\nANTES DEL CAMBIO:\n",forma,)
    forma.color = "Rojo"
    forma.centro = Punto(random.randint(0,100),random.randint(0,100))
    print("Se ha movido la forma y se ha cambiado su color.")
    print("\nDESPUÉS DEL CAMBIO:\n", forma)
